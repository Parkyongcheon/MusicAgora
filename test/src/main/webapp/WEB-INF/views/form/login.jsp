...
$(function(){
	...
	$('#usercheck').click(function(){
		...
		{
		console.log("PASS SHA256 HashData");
		console.log(SHA256(pw+salt));
		//hash sha256으로 변형된 salt + pw값
		var shapw = SHA256(pw+salt);
		
		$.ajax({
			type	: 'POST'
			,data	: { "id" : id, "pw" : shapw ,"email" : email}
			,url	: "/insertuser"
			,success: function(data)
			{
				if(data == 1)
...
<body>
	...
	<div class="form">
		...
		<form class="login-form" action="" method="post">
			...
			<input class="user-input" type="password" id="loginpw" name="loginpw" placeholder="Password" required>
