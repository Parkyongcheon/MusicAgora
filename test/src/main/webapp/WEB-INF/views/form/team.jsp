...
<body>
	...
	<div class="con">
		...
		<div class="box">
			<div class="imgBx">
				<img src="resources/images/find.jpg">
			</div>
			<div class="content">
				<h2>Search<br><span>Looking for a team</span></h2>
			</div>
		</div>
		<div class="box">
			<div class="imgBx">
				<img src="resources/images/want.jpg">
			</div>
			<div class="content">
				<h2>Wanted<br><span>Looking for a member</span></h2>
			</div>
		</div>
		<div class="box">
			<div class="imgBx">
				<img src="resources/images/pr.jpg">
			</div>
			<div class="content">
				<h2>Team PR<br><span>Introducing my team</span></h2>
			</div>
		</div>
